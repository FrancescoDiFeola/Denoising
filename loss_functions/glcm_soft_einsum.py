...
if __name__ == "__main__":
    ...
    a = torch.tensor([1])
    print(a)
    loss_terms = torch.stack([torch.tensor(10.0000), torch.tensor(5.0000), torch.tensor(1.0000), torch.tensor(2.0000), torch.tensor(3.0000), torch.tensor(1.0000)], dim=0).unsqueeze(0).unsqueeze(1).unsqueeze(2)
    normalized_loss_terms = F.normalize(loss_terms, p=1, dim=-1)
    print(normalized_loss_terms)
    print(loss_terms.shape)
