...
if __name__ == '__main__':
    ...
    opt.text_file = "./data/csv_files/mayo_test_1p.csv"  # load the csv file containing test data info
    ...
    opt.text_file = "./data/csv_files/mayo_test_ext.csv"  # load the csv file containing test data info
    dataset_test_2 = create_dataset(opt)
    print(len(dataset_test_2))

    # Test 3 (8 patient from LIDC/IDRI)
    opt.text_file = "./data/csv_files/LIDC_test.csv"  # load the csv file containing test data info
    ...
    for epoch in range(opt.epoch_count,
        ...
        tracked_weights = model.track_loss_weights()
        visualizer.plot_current_losses(epoch, float(epoch_iter) / dataset_size, current_losses, tracked_losses,
                                       'Loss_functions')
        visualizer.plot_current_weights(epoch, tracked_weights, "Loss function weights")
